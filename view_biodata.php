				...
				<div class="col-md-9 bg-light">
					...
					<div class="row bd-top mt-5 mb-5">
						...
						<div class="col-md-8 bd-top">
                            <form action="server.php" role="form" method="POST">
								...
								<div class="form-group">
									<div class="row">									
                                        ...
                                        <!-- <input type="text" name="firstname" id="firstname" class="form-control-static col-md-6" placeholder="Mojeed"> -->
								...
								<div class="form-group">
									<div class="row">
										...
										<!-- <input type="text" name="lastname" id="lastname" class="form-control-static col-md-6" placeholder="Kusimo"> -->
								...
								<div class="form-group">
									<div class="row">
										...
										<span class="form-control-static col-md-6"><?php echo $userinfo['Email']; ?></span>
									</div>
								</div>
								<div class="form-group">
									<div class="row">
										...
										<span class="form-control-static col-md-6"><?php echo $userinfo['Mobile_Number']; ?></span>
									</div>
								</div>
								<div class="form-group">
									<div class="row">
										<span class = 'col-md-6'><label for="firstname">Username: </label></span>
										<!-- <span class = 'col-md-6'><input type="text" name="username" id="username" class="form-control" placeholder="<?php echo $userinfo['Username']; ?>"></span> -->
										<span class="form-control-static col-md-6"><?php echo $userinfo['Username']; ?></span>
									</div>
								</div>
								<div class="form-group">
									<div class="row">
										<span class="col-md-6"><label for="programme">Programme: </label></span>
